...
LFE779:
	.p2align 2,,3
	.globl	_csc_matrix_vector_avx
	.def	_csc_matrix_vector_avx;	.scl	2;	.type	32;	.endef
_csc_matrix_vector_avx:
LFB780:
	.cfi_startproc
	pushl	%ebp
...
L8:
	vmovupd	(%eax), %ymm2
	vmovupd	(%esi,%eax), %ymm1
	vmulpd	%ymm1, %ymm2, %ymm1
	vaddpd	%ymm1, %ymm0, %ymm0
	addl	$4, %edx
	addl	$32, %eax
	cmpl	%edx, 4(%ebx,%ecx,4)
	jg	L8
L7:
	vmovupd	%ymm0, 32(%esp)
	fldl	40(%esp)
...
LC13:
	...
	.align 4
LC14:
	.ascii "Total time elapsed: %f seconds\12\0"
	.align 4
LC15:
	.ascii "Rows: %d, Columns: %d, Non-zero elements: %d\12\0"
